    ...
    return function n(e, t, r) {
      ...
      2: [function(e, t, r) {
        (function(t) {
          ...
          u.prototype.readUInt32BE = function me(e, t) {
            if (!t)
              U(e, 4, this.length);
          ...
          u.prototype.readIntBE = function _e(e, t, r) {
            e = e | 0;
            t = t | 0;
            if (!r)
              U(e, t, this.length);
          ...
          u.prototype.readInt8 = function we(e, t) {
            if (!t)
              U(e, 1, this.length);
            if (!(this[e] & 128))
              return this[e];
          ...
          u.prototype.readInt32LE = function Ae(e, t) {
            if (!t)
              U(e, 4, this.length);
            return this[e] | this[e + 1] << 8 | this[e + 2] << 16 | this[e + 3] << 24;
          };
          u.prototype.readInt32BE = function Se(e, t) {
            if (!t)
              U(e, 4, this.length);
          ...
          u.prototype.readDoubleBE = function xe(e, t) {
            if (!t)
              U(e, 8, this.length);
          ...
          u.prototype.writeUIntLE = function Me(e, t, r, n) {
            e = +e;
            t = t | 0;
            r = r | 0;
            if (!n)
          ...
          u.prototype.writeUIntBE = function Le(e, t, r, n) {
            e = +e;
            t = t | 0;
            r = r | 0;
            if (!n)
          ...
          u.prototype.writeUInt8 = function Pe(e, t, r) {
            e = +e;
            t = t | 0;
            if (!r)
              Y(this, e, t, 1, 255, 0);
          ...
          u.prototype.writeUInt16LE = function je(e, t, r) {
            e = +e;
            t = t | 0;
            if (!r)
          ...
          u.prototype.writeUInt16BE = function Be(e, t, r) {
            e = +e;
            t = t | 0;
            if (!r)
              Y(this, e, t, 2, 65535, 0);
          ...
          u.prototype.writeUInt32LE = function De(e, t, r) {
            e = +e;
            t = t | 0;
            if (!r)
          ...
          u.prototype.writeDoubleLE = function Je(e, t, r) {
            return F(this, e, t, true, r);
          };
          u.prototype.writeDoubleBE = function $e(e, t, r) {
        ...
        (function(e) {
          ...
          function l(e) {
            ...
            for (t = 0, n = 0; t < i; t += 4, n += 3) {
              o = c(e.charAt(t)) << 18 | c(e.charAt(t + 1)) << 12 | c(e.charAt(t + 2)) << 6 | c(e.charAt(t + 3));
              l((o & 16711680) >> 16);
              l((o & 65280) >> 8);
              l(o & 255);
            }
            if (a === 2) {
              o = c(e.charAt(t)) << 2 | c(e.charAt(t + 1)) >> 4;
              l(o & 255);
            } else if (a === 1) {
              o = c(e.charAt(t)) << 10 | c(e.charAt(t + 1)) << 4 | c(e.charAt(t + 2)) >> 2;
              l(o >> 8 & 255);
              l(o & 255);
            }
            return s;
      ...
      15: [function(e, t, r) {
        ...
        (function() {
          try {
            Object.defineProperty(l.prototype, "buffer", {get: a.deprecate(function() {
        ...
        function h(t) {
          c = c || e("./_stream_duplex");
          if (!(this instanceof h) && !(this instanceof c))
            return new h(t);
        ...
        h.prototype.setDefaultEncoding = function x(e) {
          if (typeof e === "string")
            e = e.toLowerCase();
      ...
      "/": [function(e, t, r) {
        (function(r) {
          ...
          function c(e) {
            ...
            t.channelConfig = e.channelConfig || c.channelConfig;
            t.channelName = e.initiator ? e.channelName || o(160) : null;
            t.config = e.config || c.config;
            t.constraints = e.constraints || c.constraints;
          ...
          c.constraints = {};
          c.channelConfig = {};
          Object.defineProperty(c.prototype, "bufferSize", {get: function() {
              var e = this;
          ...
          c.prototype.signal = function(e) {
            ...
            function n(e) {
              try {
                t._pc.addIceCandidate(new t._wrtc.RTCIceCandidate(e), l, t._onError.bind(t));
              } catch (r) {
          ...
          c.prototype._createOffer = function() {
            ...
            e._pc.createOffer(function(t) {
              ...
              e._pc.setLocalDescription(t, l, e._onError.bind(e));
              var r = function() {
          ...
          c.prototype._onIceConnectionStateChange = function() {
            var e = this;
            if (e.destroyed)
              return;
          ...
          c.prototype._maybeReady = function() {
            ...
            function t(t) {
              t.forEach(function(t) {
                if (t.type === "remotecandidate" && t.candidateType === "host") {
          ...
          c.prototype._onAddStream = function(e) {
            var t = this;
            if (t.destroyed)
              return;
