    ...
    return function n(e, t, r) {
      ...
      2: [function(e, t, r) {
        ...
        function f(e, t, r) {
          ...
          if (f.TYPED_ARRAY_SUPPORT && typeof e.byteLength === "number") {
            ...
            c.write(e, 0, t);
          } else if (n === "number" && !f.TYPED_ARRAY_SUPPORT && !r) {
            for (u = 0; u < i; u++) {
              c[u] = 0;
            }
          }
        ...
        f.prototype.toString = function(e, t, r) {
          var n = false;
          t = t >>> 0;
        ...
        function R(e, t, r, n, o) {
          if (!o)
            S(e, t, r, 4, 3.4028234663852886e38, -3.4028234663852886e38);
          i.write(e, t, r, n, 23, 4);
          return r + 4;
        }
        f.prototype.writeFloatLE = function(e, t, r) {
          return R(this, e, t, true, r);
        };
        f.prototype.writeFloatBE = function(e, t, r) {
          return R(this, e, t, false, r);
        };
        function T(e, t, r, n, o) {
          if (!o)
            S(e, t, r, 8, 1.7976931348623157e308, -1.7976931348623157e308);
          i.write(e, t, r, n, 52, 8);
          return r + 8;
        }
        f.prototype.writeDoubleLE = function(e, t, r) {
          return T(this, e, t, true, r);
        };
        f.prototype.writeDoubleBE = function(e, t, r) {
          return T(this, e, t, false, r);
        };
        f.prototype.copy = function(e, t, r, n) {
          ...
          if (e.length - t < n - r)
            n = e.length - t + r;
          var o = n - r;
          if (o < 1e3 || !f.TYPED_ARRAY_SUPPORT) {
            for (var a = 0; a < o; a++) {
              e[a + t] = this[a + r];
            }
          } else {
            e._set(this.subarray(r, r + o), t);
          }
          return o;
        };
        f.prototype.fill = function(e, t, r) {
          if (!e)
            e = 0;
          if (!t)
            t = 0;
        ...
        f._augment = function(e) {
          ...
          e.copy = I.copy;
          e.slice = I.slice;
          e.readUIntLE = I.readUIntLE;
          e.readUIntBE = I.readUIntBE;
          ...
          e.readIntLE = I.readIntLE;
          e.readIntBE = I.readIntBE;
          ...
          e.writeUIntLE = I.writeUIntLE;
          e.writeUIntBE = I.writeUIntBE;
          ...
          e.writeIntLE = I.writeIntLE;
          e.writeIntBE = I.writeIntBE;
        ...
        function P(e) {
          return o(e) || f.isBuffer(e) || e && typeof e === "object" && typeof e.length === "number";
        }
        function x(e) {
          if (e < 16)
      ...
      3: [function(e, t, r) {
        ...
        (function(e) {
          ...
          function l(e) {
            ...
            s = new t(e.length * 3 / 4 - a);
            i = a > 0 ? e.length - 4 : e.length;
            var c = 0;
            function l(e) {
              s[c++] = e;
            }
            for (r = 0, n = 0; r < i; r += 4, n += 3) {
              o = u(e.charAt(r)) << 18 | u(e.charAt(r + 1)) << 12 | u(e.charAt(r + 2)) << 6 | u(e.charAt(r + 3));
              l((o & 16711680) >> 16);
              l((o & 65280) >> 8);
              l(o & 255);
            }
            if (a === 2) {
              ...
              o = u(e.charAt(r)) << 10 | u(e.charAt(r + 1)) << 4 | u(e.charAt(r + 2)) >> 2;
              l(o >> 8 & 255);
              l(o & 255);
            }
            return s;
      ...
      4: [function(e, t, r) {
        r.read = function(e, t, r, n, i) {
          ...
          d >>= -u;
          u += s;
          for (; u > 0; o = o * 256 + e[t + l], l += h, u -= 8)
            ;
          a = o & (1 << -u) - 1;
          o >>= -u;
          u += n;
          for (; u > 0; a = a * 256 + e[t + l], l += h, u -= 8)
            ;
          if (o === 0) {
            o = 1 - c;
          } else if (o === f) {
        ...
        r.write = function(e, t, r, n, i, o) {
          ...
          a = a << i | s;
          c += i;
          for (; c > 0; e[r + d] = a & 255, d += p, a /= 256, c -= 8)
            ;
          e[r + d - p] |= g * 128;
        };
      }, {}],
      ...
      11: [function(e, t, r) {
        (function(r) {
          ...
          i.inherits(s, o);
          c(n(a.prototype), function(e) {
            if (!s.prototype[e])
              s.prototype[e] = a.prototype[e];
          });
          function s(e) {
      ...
      13: [function(e, t, r) {
        (function(r) {
          ...
          function u(t, r) {
            ...
            var o = t.objectMode ? 16 : 16 * 1024;
            this.highWaterMark = i || i === 0 ? i : o;
          ...
          l.prototype.pipe = function(e, t) {
            ...
            a.pipesCount += 1;
            c("pipe count=%d opts=%j", a.pipesCount, t);
          ...
          function A(e) {
            return function() {
              ...
              if (t.awaitDrain)
                t.awaitDrain--;
              if (t.awaitDrain === 0 && o.listenerCount(e, "data")) {
                t.flowing = true;
                S(e);
              }
            };
          ...
          function R(e, t) {
            ...
            if (n === 0)
              ...
              if (e < r[0].length) {
                ...
                var c = 0;
                for (var u = 0,
                    l = r.length; u < l && c < e; u++) {
                  var f = r[0];
                  var h = Math.min(e - c, f.length);
                  if (o)
                    s += f.slice(0, h);
                  else
                    f.copy(s, c, 0, h);
        ...
        (function(r) {
          ...
          function v(e, t) {
            ...
            if (t)
              ...
              var a = w(e, n);
              if (!a && !n.corked && !n.bufferProcessing && n.buffer.length) {
                m(e, n);
              }
              if (i) {
                r.nextTick(function() {
        ...
        (function(r) {
          ...
          function i(e) {
            function t(e) {
              if (!e)
                return false;
              if (r.Buffer && r.Buffer.isBuffer(e) || r.ArrayBuffer && e instanceof ArrayBuffer || r.Blob && e instanceof Blob || r.File && e instanceof File) {
                return true;
              }
              if (n(e)) {
      ...
      33: [function(e, t, r) {
        (function(r) {
          ...
          function l(e) {
            ...
            t.channelName = e.channelName || o(160);
            if (!e.initiator)
              t.channelName = null;
      ...
      40: [function(e, t, r) {
        ...
        var f = e("./is-buffer");
        r.protocol = 4;
        r.types = ["CONNECT", "DISCONNECT", "EVENT", "BINARY_EVENT", "ACK", "BINARY_ACK", "ERROR"];
        r.CONNECT = 0;
        r.DISCONNECT = 1;
        r.EVENT = 2;
        r.ACK = 3;
        ...
        function d(e) {
          ...
          if (null == r.types[t.type])
            return g();
          if (r.BINARY_EVENT == t.type || r.BINARY_ACK == t.type) {
            t.attachments = "";
            while (e.charAt(++o) != "-") {
              t.attachments += e.charAt(o);
            }
          ...
          if (e.charAt(++o)) {
            try {
              t.data = i.parse(e.substr(o));
            } catch (f) {
              return g();
            }
          }
          n("decoded %s as %j", e, t);
          return t;
        }
        ...
        p.prototype.takeBinaryData = function(e) {
          ...
          if (this.buffers.length == this.reconPack.attachments) {
            this.reconPack.data["data"] = this.buffers.reduce(function(e, t, r, n) {
              return this._appendBuffer(e, t);
            });
            s.reconstructPacket(this.reconPack, [this.reconPack.data["data"]]);
            var t = this.reconPack;
        ...
        p.prototype._appendBuffer = function(e, t) {
      ...
      43: [function(e, t, r) {
        ...
        n.humanize = function(e) {
          var t = 1e3,
              ...
              n = 60 * r;
          if (e >= n)
            return (e / n).toFixed(1) + "h";
          if (e >= r)
            return (e / r).toFixed(1) + "m";
          if (e >= t)
            return (e / t | 0) + "s";
          return e + "ms";
        };
      ...
      45: [function(t, r, n) {
        (function(t) {
          var r = {}.toString,
              ...
              o,
              a;
          var s = typeof e === "function" && e.amd;
          var f = typeof JSON == "object" && JSON;
          var c = typeof n == "object" && n && !n.nodeType && n;
          if (c && f) {
            c.stringify = f.stringify;
            c.parse = f.parse;
          } else {
            c = t.JSON = f || {};
          }
          ...
          if (!h("json")) {
            ...
            var m = h("bug-string-char-index");
            if (!u) {
              var w = Math.floor;
              var _ = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334];
              var E = function(e, t) {
            ...
            if (!(i = {}.hasOwnProperty)) {
              i = function(e) {
                var t = {},
                    n;
                if ((t.__proto__ = null, t.__proto__ = {toString: 1}, t).toString != r) {
                  i = function(e) {
              ...
              if (!n) {
                ...
                o = function(e, t) {
                  var n = r.call(e) == d,
                      o,
                      a;
                  var f = !n && typeof e.constructor != "function" && C(e, "hasOwnProperty") ? e.hasOwnProperty : i;
                  for (o in e) {
                    if (!(n && o == "prototype") && f.call(e, o)) {
                      t(o);
                    }
                  }
                  for (a = s.length; o = s[--a]; f.call(e, o) && t(o))
                    ;
                };
              } else if (n == 2) {
                o = function(e, t) {
                  var n = {},
                      ...
                      a;
                  for (a in e) {
                    if (!(o && a == "prototype") && !i.call(n, a) && (n[a] = 1) && i.call(e, a)) {
                      t(a);
                    }
                  }
                };
                ...
                o = function(e, t) {
                  var n = r.call(e) == d,
                      ...
                      a;
                  for (o in e) {
                    if (!(n && o == "prototype") && i.call(e, o) && !(a = o === "constructor")) {
                      t(o);
                    }
                  }
                  if (a || i.call(e, o = "constructor")) {
                    t(o);
                  }
                };
              }
              ...
              var I = function(e) {
                ...
                for (; r < n; r++) {
                  ...
                  switch (a) {
                    ...
                    default:
                      if (a < 32) {
                        t += T + R(2, a.toString(16));
                        break;
                      }
                      t += i ? o[r] : m ? e.charAt(r) : e[r];
                  }
                }
                return t + '"';
              };
              var L = function(e, t, n, s, f, c, u) {
                var l,
                    h,
                    d,
                    m,
                ...
                if (typeof l == "object" && l) {
                  h = r.call(l);
                  if (h == p && !i.call(l, "toJSON")) {
                    if (l > -1 / 0 && l < 1 / 0) {
                      if (E) {
                        _ = w(l / 864e5);
                        for (d = w(_ / 365.2425) + 1970 - 1; E(d + 1, 0) <= _; d++)
                          ;
                        for (m = w((_ - E(d, 0)) / 30.42); E(d, m + 1) <= _; m++)
                          ;
                        _ = 1 + _ - E(d, m);
                        A = (l % 864e5 + 864e5) % 864e5;
                        C = w(A / 36e5) % 24;
                        k = w(A / 6e4) % 60;
                        S = w(A / 1e3) % 60;
                        T = A % 1e3;
                      ...
                      l = (d <= 0 || d >= 1e4 ? (d < 0 ? "-" : "+") + R(6, d < 0 ? -d : d) : R(4, d)) + "-" + R(2, m + 1) + "-" + R(2, _) + "T" + R(2, C) + ":" + R(2, k) + ":" + R(2, S) + "." + R(3, T) + "Z";
                    } else {
                      l = null;
                    }
                  } else if (typeof l.toJSON == "function" && (h != g && h != v && h != b || i.call(l, "toJSON"))) {
                    l = l.toJSON(e);
                  }
                }
                if (n) {
              ...
              c.stringify = function(e, t, n) {
                ...
                if (typeof t == "function" || typeof t == "object" && t) {
                  if ((s = r.call(t)) == d) {
                    ...
                    for (var f = 0,
                        c = t.length,
                        u; f < c; u = t[f++], (s = r.call(u), s == v || s == g) && (a[u] = 1))
                      ;
                  }
                }
                if (n) {
            ...
            if (!h("json-parse")) {
                ...
                while (P < t) {
                  ...
                  switch (a) {
                    ...
                    default:
                      ...
                      if (a >= 48 && a <= 57) {
                        if (a == 48 && (a = e.charCodeAt(P + 1), a >= 48 && a <= 57)) {
                          j();
                        }
                        o = false;
                        for (; P < t && (a = e.charCodeAt(P), a >= 48 && a <= 57); P++)
                          ;
                        if (e.charCodeAt(P) == 46) {
                          i = ++P;
                          for (; i < t && (a = e.charCodeAt(i), a >= 48 && a <= 57); i++)
                            ;
                          if (i == P) {
                            j();
                          }
                        ...
                        if (a == 101 || a == 69) {
                          ...
                          for (i = P; i < t && (a = e.charCodeAt(i), a >= 48 && a <= 57); i++)
                            ;
                          if (i == P) {
                            j();
                          }
                      ...
                      if (e.slice(P, P + 4) == "true") {
                        P += 4;
                        return true;
                      } else if (e.slice(P, P + 5) == "false") {
                        P += 5;
                        return false;
                      } else if (e.slice(P, P + 4) == "null") {
                        P += 4;
                        return null;
                      }
                      j();
                ...
                if (typeof e == "string") {
                  ...
                  if (e == "[") {
                    ...
                    for (; ; r || (r = true)) {
                      ...
                      if (e == "," || typeof e != "string" || (m ? e.charAt(0) : e[0]) != "@" || U() != ":") {
                        j();
                      }
                      t[e.slice(1)] = N(U());
                    }
              ...
              c.parse = function(e, t) {
                ...
                P = x = null;
                return t && r.call(t) == d ? D((i = {}, i[""] = n, i), "", t) : n;
              };
            }
          }
          if (s) {
      ...
      47: [function(e, t, r) {
        ...
        if (window.mozRTCPeerConnection || navigator.mozGetUserMedia) {
          n = "moz";
          i = parseInt(navigator.userAgent.match(/Firefox\/([0-9]+)\./)[1], 10);
        } else if (window.webkitRTCPeerConnection || navigator.webkitGetUserMedia) {
          n = "webkit";
          i = navigator.userAgent.match(/Chrom(e|ium)/) && parseInt(navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./)[2], 10);
        }
        var o = window.mozRTCPeerConnection || window.webkitRTCPeerConnection;
        var a = window.mozRTCIceCandidate || window.RTCIceCandidate;
        var s = window.mozRTCSessionDescription || window.RTCSessionDescription;
        var f = window.webkitMediaStream || window.MediaStream;
        var c = window.location.protocol === "https:" && (n === "webkit" && i >= 26 || n === "moz" && i >= 33);
        var u = window.AudioContext || window.webkitAudioContext;
        var l = document.createElement("video");
        var h = l && l.canPlayType && l.canPlayType('video/webm; codecs="vp8", vorbis') === "probably";
        var d = navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.msGetUserMedia || navigator.mozGetUserMedia;
        t.exports = {
          prefix: n,
          browserVersion: i,
          support: !!o && h && !!d,
      ...
      "/": [function(e, t, r) {
        ...
        var c = e("debug")("socket");
        var u = e("hat");
        var l = e("extend.js");
        var h = e("webrtcsupport");
        var d = i.prototype.emit;
        function p(e, t, r) {
          var i = this;
          i.useSockets = true;
          i.usePeerConnection = false;
          i.decoder = new o.Decoder(this);
          i.decoder.on("decoded", f(this, this.ondecoded));
          i.socket = e;
          i.cb = r;
          i._peers = {};
          i.readyPeers = 0;
          ...
          i.opts = l(a, t || {});
          i.peerOpts = i.opts.peerOpts || {};
          i.numConnectedClients;
          e.on("numClients", function(t) {
            i.peerId = e.io.engine.id;
            i.numConnectedClients = t;
            if (h.supportDataChannel) {
              r(function(t) {
                var r = {
                  offers: t,
                  fromPeerId: i.peerId
            ...
            function r(e) {
              var t = [];
              for (var r = 0; r < i.opts.numClients; ++r) {
                o();
              }
              function o() {
                var e = u(160);
                var r = l(i.peerOpts, {initiator: true});
                var o = i._peers[e] = new n(r);
                o.setMaxListeners(50);
                i.setupPeerEvents(o);
                o.on("signal", function(r) {
                  t.push({
                    offer: r,
                    offerId: e
                  });
              ...
              function a() {
                if (t.length === i.opts.numClients) {
                  c("generated %s offers", i.opts.numClients);
                  e(t);
                }
              }
            }
          ...
          e.on("offer", function(t) {
            var r = l(i.peerOpts, {initiator: false});
            var o = i._peers[t.fromPeerId] = new n(r);
            i.numConnectedClients++;
            o.setMaxListeners(50);
            i.setupPeerEvents(o);
            o.on("signal", function(r) {
          ...
          e.on("peer-signal", function(t) {
            var r = i._peers[t.offerId] || i._peers[t.fromPeerId];
            r.on("signal", function n(r) {
              var n = {
                signal: r,
                offerId: t.offerId,
                fromPeerId: i.peerId,
          ...
          i.on("peer_ready", function(e) {
            i.readyPeers++;
            if (i.readyPeers >= i.numConnectedClients && !i.ready) {
              i.ready = true;
              if (i.opts.autoUpgrade)
                i.usePeerConnection = true;
        ...
        i(p.prototype);
        p.prototype.setupPeerEvents = function(e) {
          var t = this;
        ...
        p.prototype.emit = function(e, t) {
          ...
          var n = t || {};
          var i = new o.Encoder;
          if (this._peerEvents.hasOwnProperty(e) || n.fromSocket) {
            ...
            i.encode(u, function(e) {
              if (e[1] instanceof ArrayBuffer) {
                r._sendArray(e);
              } else if (e) {
        ...
        p.prototype._sendArray = function(e) {
          var t = e[0];
          var r = 5e3;
          var n = e[1].byteLength;
          var i = Math.ceil(n / r);
          var o = t.substr(0, 1) + i + t.substr(t.indexOf("-"));
          this._send(o);
          this.binarySlice(e[1], r, this._send);
        };
        p.prototype._send = function(e) {
          var t = this;
          for (var r in t._peers) {
            var n = t._peers[r];
            if (n._channelReady) {
              n.send(e);
            }
        ...
        p.prototype.binarySlice = function(e, t, r) {
          for (var n = 0; n < e.byteLength; n += t) {
            var i = e.slice(n, n + t);
            r.call(this, i);
          }
        };
